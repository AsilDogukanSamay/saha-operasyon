...
# KEYERROR HATASINI ÇÖZEN GÜVENLİ KONUM ALMA BLOĞU
try:
...
# Eğer loc_data bir sözlükse ve 'coords' anahtarını içeriyorsa veriyi al
...
if not view_df.empty:
    ...
    # Mesafe Hesaplama (Hata korumalı)
    if user_lat:
    ...
    with dashboard_tabs[0]:
        ...
        # GÜNCELLENMİŞ CANLI KONUM NOKTASI
        if user_lat:
            layers.append(
                pdk.Layer(
                    "ScatterplotLayer",
